...
# OpenAI API key
openai_api_key = 'sk_test_51O0UZMEjEUifDw25IPTDEnk2k3S4XDTnuzdWoyA3YEQLd2NWANy2kUBPvVRUjRsrtQoFzGmfwRgCsY6B7A9sbqgZ00d2zkoh10'  
...
if image_data:  # Check if the image was encoded successfully
    ...
    msg = chain.invoke([HumanMessage(content=prompt)])
