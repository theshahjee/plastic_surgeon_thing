...
def mark_coordinates_on_image(image_path, coordinates_list):
    ...
    # Loop through the coordinates and mark each with a red dot and a number
    for index, point in enumerate(coordinates_list):
        ...
        cv2.putText(image, str(index + 1), (x - 5, y + 5), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1, cv2.LINE_AA)
